    ...
    <DisclaimerContainer>
      ...
      <DisclaimerContent>
        <h3>
          ...
          Neither ClickBank nor the author are engaged in rendering medical or
          ...
          provider. You should not construe ClickBank's sale of this product as
          an endorsement by ClickBank of the views expressed herein, or any
        ...
        <p>
          The ProDentim Site (the "Site") is an online information service,
          ...
          ProDentim MAY MODIFY THIS AGREEMENT AT ANY TIME, AND SUCH
        ...
        <p>
          ...
          trademarks are ProDentim, its affiliates or other third party
          ...
          materials. You agree to grant to ProDentim a non-exclusive,
          ...
          newsgroups) or by e-mail to ProDentim by all means and in any media
          now known or hereafter developed. You also grant to ProDentim the
          ...
          shall have no recourse against ProDentim for any alleged or actual
          infringement or misappropriation of any proprietary right in your
          communications to ProDentim.
        </p>
        <h3>TRADEMARKS.</h3>
        <p>
          Publications, products, content or services referenced herein or on
          the Site are the exclusive trademarks or service marks of ProDentim.
        ...
        <p>
          ...
          clearly identified as being supplied by ProDentim, ProDentim does not
          operate, control or endorse any information, products or services on
          the Internet in any way. Except for ProDentim - identified
          ...
          offered by third parties, which are not affiliated with ProDentim. You
          also understand that ProDentim cannot and does not guarantee or
        ...
        <p>
          ...
          THE INTERNET. ProDentim PROVIDES THE SITE AND RELATED INFORMATION "AS
          ...
          ProDentim SHALL NOT BE LIABLE FOR ANY COST OR DAMAGE ARISING EITHER
          ...
          PROVIDED THROUGH THE SERVICE OR ON THE INTERNET GENERALLY. ProDentim
        ...
        <p>
          ...
          ProDentim HAS NO CONTROL OVER AND ACCEPTS NO RESPONSIBILITY WHATSOEVER
          FOR SUCH MATERIALS.
        </p>
        <h3>LIMITATION OF LIABILITY</h3>
        <p>
          IN NO EVENT WILL ProDentim BE LIABLE FOR (I) ANY INCIDENTAL,
          ...
          INFORMATION OR SERVICE. EVEN ProDentim OR ITS AUTHORIZED
          ...
          ABOVE LIMITATION MAY NOT APPLY TO YOU. IN SUCH STATES ProDentim
          LIABILITY IS LIMITED TO THE GREATEST EXTENT PERMITTED BY LAW.
        </p>
        <p>
          ProDentim makes no representations whatsoever about any other web site
          which you may access through this one or which may link to this Site.
          When you access a non- ProDentim web site, please understand that it
          is independent from ProDentim, and that ProDentim has no control over
          the content on that web site. In addition, a link to a ProDentim web
          site does not mean that ProDentim endorses or accepts any
          responsibility for the content, or the use, of such web site.
        </p>
        <h3>3. Indemnification.</h3>
        <p>
          You agree to indemnify, defend and hold harmless ProDentim, its
        ...
        <p>
          ...
          (Indemnification) are for the benefit of ProDentim and its officers,
        ...
        <p>
          ...
          any legal action or proceeding between ProDentim and you for any
          ...
          arises or such claim or cause of action is barred. ProDentim failure
          ...
          ProDentim may assign its rights and duties under this Agreement to any
          party at any time without notice to you.
        </p>
        <p>
          Some names have been changed and some testimonials have been recorded
          with paid actors to protect the anonymity of those involved. No
          identification with actual persons (living or deceased), places,
